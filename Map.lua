...
function Map:init()
    ...
    while x < self.mapWidth do
        ...
        if x > self.mapWidth-2 then
            ...
            x = x + 1
        elseif math.random(5) == 1 and x < self.mapWidth - 8  and x > self.mapWidth/2 then
            h = math.random(8)
        ...
        elseif math.random(20) == 1 and x < self.mapWidth-6 then
            -- left side of pipe
        ...
        elseif math.random(10) == 1 and x < self.mapWidth - 6 then
...
function Map:render()
    ...
    if gameState == 'done' then
        ...
        love.graphics.printf('VICTORY!!!', 0, VIRTUAL_HEIGHT / 2, VIRTUAL_WIDTH, 'center')
    end
end
